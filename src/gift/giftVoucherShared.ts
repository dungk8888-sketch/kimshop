...
.gift-box-lid{position:absolute;top:11px;left:50%;transform:translateX(-50%);width:122px;height:33px;border-radius:15px;background:linear-gradient(180deg,#2E6BFF 0%,#1D4ED8 100%);box-shadow:0 12px 18px rgba(0,0,0,.16),inset 0 2px 2px rgba(255,255,255,.28);z-index:4;overflow:hidden}
...
.gift-box-bow{position:absolute;top:2px;left:50%;transform:translateX(-50%);width:62px;height:29px;z-index:6}
