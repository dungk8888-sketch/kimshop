...
import { Gift, X, Copy, Check, Loader2, Lock, ShieldAlert, PartyPopper } from 'lucide-react';
...
import { GIFT_HERO_OPEN_DATA_URI } from './giftHeroData';
          ...
          {(phase === 'teaser' || phase === 'opening') && campaign && (
            <>
              <div className="relative mb-5 flex flex-col items-center gift-premium-hero w-full">
                ...
                <div className={`gift-box-wrap gift-render-wrap ${boxWrapAnimClass}`}>
                  <div className={`gift-render-frame ${boxStage === 'burst' ? 'is-open' : ''}`}>
                    <img
                      src={GIFT_HERO_OPEN_DATA_URI}
                      alt="Hộp quà KIMSHOP xanh vàng đang mở"
                      className="gift-render-image"
                      draggable={false}
                    />
                    <div className="gift-render-sheen" />
                    <div className="gift-render-glow" />
                  </div>
