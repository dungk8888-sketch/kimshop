...
// The home query effect fires after boot. Do not let its 4-row refresh erase a larger cache.
once(
...
'preserve full default storefront cache');

// Cache every default-home page that has actually loaded. Never let search/category/sort overwrite home cache.
once(
...
'append all loaded default-home pages to cache');
