...
// Just-submitted review: use the recipient already mapped in the local order model.
...
console.log('[KIMSHOP FIX] review recipient/order name applied without nonexistent customer_name column');
